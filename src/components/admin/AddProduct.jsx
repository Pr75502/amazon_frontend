...
import { addProduct, deleteProduct, fetchProducts } from "../../features/productSlice";
...
const AddProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // navigate("/admin/products"); // This line is commented out in the original addProductUser.jsx, keeping it consistent for now.
